...
class BasketballShootingAnalyzer:
    def __init__(self, model_path='pretrain_model_epoch_30.pth', handedness='right'):
...
def analyze_video(video_path, model_path='pretrain_model_epoch_30.pth', handedness='right'):
    """비디오 파일 분석"""
