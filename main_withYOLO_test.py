...
def main():
    # YOLO 모델 GPU 설정
    person_model = YOLO('yolov8l-pose.pt')
    ...
    while True:
        ...
        # 농구공 탐지 - GPU 활용 (고정된 이미지 크기 사용)
        ball_results = ball_model.predict(frame, imgsz=1280, conf=0.2, verbose=False, classes=[0])  # 더 큰 고정 크기 사용
    ...
    print("\nProcessing complete!")
    print("Output video saved as 'output_test.mp4'")
